...
Примечание1: Графические файлы показывают полученную в назначенном эл.почте письма с логами и само эл.письмо
Примечание2: Для экономии времени тестовые эл.сообщения в графическом homework10_2.png файле отправлялись с интервалом в 3 минуты
```
